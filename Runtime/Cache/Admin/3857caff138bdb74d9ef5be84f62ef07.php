...
<div class="tab-wrap">
    ...
    <!-- 表单 -->
    <form id="form" action="<?php echo U('add?model='.$model['id']);?>" method="post" class="form-horizontal" enctype="multipart/form-data">
        <!-- 基础文档模型 -->
                    ...
                    <div class="controls">
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-mid" name="<?php echo ($field["name"]); ?>" value=""><?php break;?>
                            ...
                            <?php case "picture": ?><div class="controls">
									<input type="file" id="upload_picture_<?php echo ($field["name"]); ?>" name>
