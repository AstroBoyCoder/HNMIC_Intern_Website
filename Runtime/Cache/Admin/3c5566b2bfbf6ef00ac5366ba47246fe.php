        ...
        <div class="login-body">
            <div class="login-main pr">
                <form action="<?php echo U('login');?>" method="post" class="login-form">
                    <h3 class="welcome">HIP工作室管理平台</h3>
    ...
    <script type="text/javascript">
        ...
        $("form").submit(function () {
            ...
            xhr.onreadystatechange = function () {
                ...
                //发送 - 第四步
                xhr.open("POST", "http://hip666.azurewebsites.net/admin.php?s=/Public/login.html", true);
            ...
            // var self = $(this);
            // console.log(self.attr("action"), self.serialize());

            // $.post("http://hip666.azurewebsites.net/admin.php?s=/Public/login.html", self.serialize(), success, "json");
            // return false;
